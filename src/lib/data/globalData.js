...
export const socialLinkItems = {
  ...
  dribbble: { name: "Dribbble", icon: icon3 },
  instagram: { name: "Instagram", icon: icon4 },
  discord: { name: "Discord", icon: icon5 },
  deviantart: { name: "DeviantArt", icon: icon6 },
  reddit: { name: "Reddit", icon: icon7 },
  twitch: { name: "Twitch", icon: icon8 },
};
