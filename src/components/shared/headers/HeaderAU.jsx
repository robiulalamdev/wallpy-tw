                ...
                <div className="p-0 shadow-none border-none rounded-[10px] bg-[#00000080] w-[289px] h-[72px] grid grid-cols-2">
                  <Button
                    onClick={() => {
                      ...
                      setIsLogged(localStorage.getItem("wps"));
                    }}
                  ...
                  <Button className="shadow-none hover:shadow-none w-full h-full text-[#fff] bg-transparent normal-case font-normal text-[15px] font-bakbak-one p-0 m-0 flex justify-center items-center gap-x-[7px] rounded-none">
                    {iRegister} Register
                  </Button>
                </div>
              </>
