    ...
    <>
      ...
      <div className="max-w-[425px] mx-auto w-full h-fit mt-[12px]">
        <div className="size-[87px] rounded-full bg-[#00000080] flex justify-center items-center mx-auto">
          <img
            src={
              viewResizeImg(image || open?.profile?.profile_image, 85, 85) ||
              DefaultProfile
            }
            alt=""
        ...
        <img
          src={viewResizeImg(banner || open?.profile?.banner) || bannerImg}
          alt=""
          className="mt-[34px] mx-auto w-[232px] h-[34px] object-cover rounded-[5px]"
        />
