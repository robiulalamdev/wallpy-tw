...
const UsersTableRow = ({
  ...
  return (
    <div className="w-full h-fit flex items-center mt-[23px]">
      ...
      <div className="text-white font-lato text-[15px] min-w-[170px] max-w-[170px] ml-[37px]">
        {data?.username}
      </div>
      <div className="text-[#8F8F8F] font-lato text-[15px] text-nowrap min-w-[190px] max-w-[190px] ml-[55px]">
        {data?.email}
      </div>
