  ...
  return (
    <>
      <div
        ...
        style={{
          background: `linear-gradient(0deg, rgba(0, 0, 0, 0.20) 0%, rgba(0, 0, 0, 0.20) 100%), url(${notFound}) lightgray 50% / cover no-repeat`,
        }}
      >
        <div className="">
      ...
      <div
        ...
        style={{
          background: `url(${notFoundSm}) lightgray 50% / cover no-repeat`,
        }}
      >
        <div className="">
